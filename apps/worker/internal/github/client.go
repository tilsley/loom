...
// FileContent represents a file retrieved from the GitHub contents API.
...
func (c *Client) GetContents(ctx context.Context, owner, repo, path string) (*FileContent, error) {
